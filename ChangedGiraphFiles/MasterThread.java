...
public class MasterThread<I extends WritableComparable, V extends Writable,
  ...
  public void run() {
    ...
    try {
      System.out.println("START_MILLIS: " + System.currentTimeMillis());
      ...
      if (bspServiceMaster.becomeMaster()) {
        ...
        if (bspServiceMaster.getRestartedSuperstep() !=
          ...
          while (!superstepState.isExecutionComplete()) {
            ...
            if (cachedSuperstep == BspService.INPUT_SUPERSTEP) {
              System.out.println("POST_SETUP_MILLIS: " + System.currentTimeMillis());
            }
          }
      ...
      System.out.println("POST_OUTPUT_MILLIS: " + System.currentTimeMillis());
